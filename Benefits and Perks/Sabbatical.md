...
After every 5 years of working at ToneDen, employees are encouraged to take a one-quarter (12 contiguous weeks) paid sabbatical.
...
There is an expectation that employees return to work at ToneDen after their sabbatical, and not use it as a soft exit from the company. We may set some policy to enforce this later.
